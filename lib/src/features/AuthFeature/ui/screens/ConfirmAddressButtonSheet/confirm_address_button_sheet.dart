...
import 'Component/area_sheet.dart';
import 'Component/city_sheet.dart';

class ShopAddressButtonSheet extends StatefulWidget {
  @override
  State<ShopAddressButtonSheet> createState() => _ShopAddressButtonSheetState();
}
class _ShopAddressButtonSheetState extends State<ShopAddressButtonSheet> {
  @override
                      ...
                      InkWell(
                        onTap: (){
                         if(_.areaList!.isEmpty){
                           ...
                           Get.bottomSheet(AreaButtonSheet(areaList: _.areaList!,));
                         }
                        },
                        child: TextFieldDefault(
                          hint: 'area_'.tr,
