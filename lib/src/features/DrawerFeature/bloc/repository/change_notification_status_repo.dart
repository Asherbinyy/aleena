...
class ChangeNotificationsStatusRepository with ApiKey{
  // GetStorage box = GetStorage();
  NetworkService _networkService = NetworkService();
  Future<Response> changeNotificationsStatus({required int notificationsStatus})async{
    Response response;
    try{
      response = await _networkService.post(
          url:uRLChangeNotificationsStatus,
          auth: true,
          body: {
