...
import 'package:aleena/src/features/DrawerFeature/bloc/controller/return_orders_controller.dart';
...
class ReturnOrdersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ReturnOrdersController _returnOrdersController = Get.put(ReturnOrdersController());
    Future<void> onRefresh()async{
      await _returnOrdersController.fetchReturnOrders();
    }
    ...
    return Scaffold(
      body: ScaffoldBackground(
          ...
          child: GetBuilder<ReturnOrdersController>(
